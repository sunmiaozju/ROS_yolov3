...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        if(filename == NULL){
            printf("Need to Enter the Image Path");
            exit(0);
        }
        ...
        while((ptr = readdir(dir)) != NULL){
            ...
            if(outfile){
                ...
                strcpy(save_path, "/home/sunmiao/projects/darknet-master/myDataset/tianjin_selected/output/out_");
                strcat(save_path, ptr->d_name);

                pch = strtok(save_path, ".");

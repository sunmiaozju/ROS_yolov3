...
void YoloObjectDetector::init()
{
  ...
  //printf("%s", cameraTopicName.c_str());
...
bool YoloObjectDetector::publishDetectionImage(const cv::Mat& detectionImage)
{
  ...
  //cv::imwrite("/home/sunmiao/projects/catkin_workspace/777.png", detectionImage);
...
void YoloObjectDetector::yolo()
{
  ...
  while (!demoDone_) {
    ...
    if (!demoPrefix_) {
      ...
      //save_image(buff_[(buffIndex_ + 1) % 3], "1234.png");
      publishInThread();
    } else {
      char name[256];
...
void *YoloObjectDetector::publishInThread()
{
  ...
  //cv::imwrite("/home/sunmiao/projects/catkin_workspace/XXX.png", cvImage);
